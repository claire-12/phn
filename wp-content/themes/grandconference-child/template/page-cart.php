	...
	<div class="page_title_wrapper">
		<div class="standard_wrapper">
			<div class="page_title_inner">
				<div class="page_title_content flex">
					<h1>
						<?php 
                    ...
                    <?php 
                       if($id_ticket != 0){
                        $lan = get_field('language',$id_ticket);
                        $back = ($lan === 'french') ? get_field('back_fr') : get_field('back');
                        echo "<a href='".get_permalink( $id_ticket )."' class='button button-back-event'>$back</a>";
                       }
                    ?>
				</div>
			</div>
