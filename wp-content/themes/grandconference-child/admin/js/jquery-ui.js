...
$.extend( Datepicker.prototype, {
	...
	_generateHTML: function( inst ) {
		...
		var day_available = new Array();
		var id_variation = $('.modal-calendar').data('value');
		$(''+id_variation+' .day-available input').each(function() {
			day_available.push($(this).val());
		});
			...
			for ( col = 0; col < numMonths[ 1 ]; col++ ) {
				...
				for ( dRow = 0; dRow < numRows; dRow++ ) { // create date picker rows
					...
					for ( dow = 0; dow < 7; dow++ ) { // create date picker days
						var dayString = printDate.getDate().toString(),
                            monthString = (printDate.getMonth()+1).toString(),
                            yearString = printDate.getFullYear().toString();
							if(monthString < 10){
						...
						tbody += "<td class='" + (jQuery.inArray(dataDate, day_available) != -1 ? " day-available" : "") +
